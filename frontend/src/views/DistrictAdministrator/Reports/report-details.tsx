...
const DistrictAdministratorReportDetailsPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        className={`${!isMobile ? "pt-[100px] pl-[100px] ml-[10%] pr-[10px]" : "w-full px-2 py-20"}`}
      >
...
export default DistrictAdministratorReportDetailsPage;
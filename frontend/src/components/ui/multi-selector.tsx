...
>(
  (
    ...
    const [selectedOptionsString, setSelectedOptionsString] = React.useState(
      value || "",
    );
    ...
    React.useImperativeHandle(
      ref,
      () => ({
        selectedValue: selectedOptionsString,
    ...
    const handleUnselect = React.useCallback(
      (option: Option) => {
        ...
        const newSelectedOptionsString = newOptions
          .map((o) => o.value)
          .join(", ");
        setSelected(newOptions);
        setSelectedOptionsString(newSelectedOptionsString);
    ...
    useEffect(() => {
      if (value) {
        setSelected(value.split(", ").map((v) => ({ value: v, label: v })));
        setSelectedOptionsString(value);
      }
    }, [value]);
    ...
    const CreatableItem = () => {
      ...
      if (
        ...
        selectedOptionsString.includes(inputValue)
      ) {
        return undefined;
      }
      ...
      const Item = (
        <CommandItem
          ...
          onSelect={(value: string) => {
            ...
            setInputValue("");
            const newSelectedOptionsString = `${selectedOptionsString}${
              selectedOptionsString ? ", " : ""
            }${value}`;
            setSelectedOptionsString(newSelectedOptionsString);
            onChange?.(newSelectedOptionsString);
        ...
        >
          <div className="flex flex-wrap gap-1">
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                "flex-1 bg-transparent outline-none placeholder:text-black dark:placeholder:text-white",
                {

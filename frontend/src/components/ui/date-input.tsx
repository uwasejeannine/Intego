  ...
  return (
    <div className="flex border rounded-lg items-center text-sm px-1">
      <input
        ...
        className="p-0 outline-none w-7 border-none dark:bg-slate-950 dark:text-white text-center"
        placeholder="D"
      />

      <span className="opacity-20 -mx-px dark:text-white">/</span>
      <input
        type="text"
        ref={monthRef}
        max={12}
        ...
        className="p-0 outline-none w-6 border-none dark:bg-slate-950 dark:text-white text-center"
        placeholder="M"
      />
      ...
      <input
        ...
        className="p-0 outline-none w-12 border-none dark:bg-slate-950 dark:text-white text-center"
        placeholder="YYYY"
      />
    </div>
  );
